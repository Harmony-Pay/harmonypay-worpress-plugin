...
{
    public static function get_currency($key) {
        $currencies = array (
            'AFN' => 
            array (
              'alphabeticCode' => 'AFN',
    ...
    public static function get_currency_in_subunit($key, $amount) {
        $currency = self::get_currency($key);
        $no_decimal_places = is_null($currency) ? 2: $currency['minorUnit'];
        return (float) $amount * pow(10, $no_decimal_places);
    }

    public static function get_currency_in_unit($key, $amount) {
        $currency = self::get_currency($key);
        $no_decimal_places = is_null($currency) ? 2: $currency['minorUnit'];
        return (float) $amount / pow(10, $no_decimal_places);
    }
